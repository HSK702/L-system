...
function aggiungiStringaCronologia(num, str) {
  var riga = createDiv("#" + num + ": " + str);
  riga.parent(cronologiaDisplay);
  riga.style('word-break', 'break-all');
  riga.style('margin-bottom', '5px');
}
